    ...
    <div className="experience-container">
      ...
      <VerticalTimeline lineColor="#aaa">
        <VerticalTimelineElement
          ...
          date="2023 - Present"
          contentStyle={{ background: '#869cd5', borderRadius: '15px', boxShadow: '0 5px 15px rgba(0,0,0,0.2)' }}
          iconStyle={{ background: '#869cd5', color: '#fff' }}
          icon={<WorkIcon />}
        >
          <h3 className="vertical-timeline-element-title">[Company Name], [Position]</h3>
